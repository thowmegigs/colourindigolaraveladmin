                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="align-items-center">
                                        <div class="form-check form-check-inline"><input
                                                onchange="toggleContentSections(this.value)" type="radio"
                                                name="content_type" id="inp-type-Cart" value="Products" checked=""
                                                class="form-check-input"><label for="inp-type-Cart"
                                                class="form-check-label">Products Only</label></div>
                                        <div class="form-check form-check-inline"><input
                                                onchange="toggleContentSections(this.value)" type="radio"
                                                name="content_type" id="inp-type-Individual Quantity" value="Categories"
                                                class="form-check-input"><label for="inp-type-Individual Quantity"
                                                class="form-check-label">Categories Only
                                            </label></div>
                                        <div class="form-check form-check-inline"><input
                                                onchange="toggleContentSections(this.value)" type="radio"
                                                name="content_type" id="inp-type-BOGO" value="Collections"
                                                class="form-check-input"><label for="inp-type-BOGO"
                                                class="form-check-label">Collections Only</label></div>
                                        <div class="form-check form-check-inline"><input
                                                onchange="toggleContentSections(this.value)" type="radio"
                                                name="content_type" id="inp-type-Bulk" value="Banner"
                                                class="form-check-input"><label for="inp-type-Bulk"
                                                class="form-check-label">Banner Only</label></div>
                                        <div class="form-check form-check-inline"><input
                                                onchange="toggleContentSections(this.value)" type="radio"
                                                name="content_type" id="inp-type-Bulk" value="Slider"
                                                class="form-check-input"><label for="inp-type-Bulk"
                                                class="form-check-label">Slider Only</label></div>
                               ...
                               <input type="color" name="border_color" class="form-control" value="#FFFFFF">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="color" name="background_color" id="item_background_color"
                                        class="form-control">

                                </div>
                                <div class="col-md-6 mb-4">
                                    <label class="form-label" for="product-title-input">Section Background Color
                                    </label>

                                    <input type="color" name="section_background_color" id="section_background_color"
                                        class="form-control">

                                </div>
                                <div class="col-md-6 mb-3">

                                    <div class="form-group"><label for="inp-section_title" class="">Section
                                            Display Title</label>
                                        <input type="text" name="section_title" id="inp-section_title" value=""
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-group"><label for="inp-section_subtitle" class="">Section
                                            Display Subtitle</label>
                                        <input type="text" name="section_subtitle" id="inp-section_subtitle"
                                            value="" class="form-control" placeholder="Enter section subtitle">
                                    </div>
