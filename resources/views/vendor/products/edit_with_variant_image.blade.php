        ...
        <div class="row">
            <div class="col-md-7">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label" for="product-title-input">MRP<span
                                            class="text-danger">*</span>  <small class="text-muted ms-1" style="font-size:11px">(Lowest price of all variants)</small></label>
                ...
                <!-- <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Package Dimensions</div>
                    </div>
                    <div class="card-body">
                        @php 
                ...
                <div class="card my-2">
                    <div class="card-header mb-0 py-1">
                        <h5 class="card-title my-1">Inventory</h5>
                    ...
                    <div class="card-body py-1">
                        ...
                        <div class="row">
                               <div class="col-md-6 mb-4">
                            <label class="form-label" for="product-title-input">SKU  <small class="text-muted">(Same for all only size variants)</small></label>

                            <input type="text" id="inp-sku" class="form-control" name="sku" required value="{{ $model->sku }}"
                            ...
                            <div class="col-md-6 mb-4 d-none">
                                ...
                                <input type="hidden" class="form-control" name="quantity" required
                                    placeholder="Enter quantity in stock" value="0">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input id="max_qty" type="number" class="form-control"
                                        value="{{ $model->max_quantity_allowed??5 }}" name="max_quantity_allowed"
            ...
            <div class="col-md-5">
                 <div class="accordion mb-2" id="default-accordion-example">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse @if(!is_null($facet_atributes)) show @endif" aria-labelledby="headingOne" data-bs-parent="#default-accordion-example" style="max-height:300px;overflow-y:auto;">
                                <div class="accordion-body pb-3">
                                     <div id="feature" >
                                        @if($facet_atributes->count()>0)
                                            ...
                                            <div class="accordion" id="accord">
                                                @if (!empty($model->variants))
                                                    @foreach ($model->variants as $variant)
                                                        <div class="accordion-item  mb-2" data-id="{{$variant->id}}">
                                                            <div class="accordion-header d-flex flex-between">
                                                              
                                                        <button class="btn btn-outline-danger rounded-0" style="min-width:30px" type="button">
                                                        <i class="bi bi-trash " onClick="deleteAccordian(this,'{!!$variant->id!!}')" style="font-sze:20px;"></i>
                                                        </button> 
                                                         <button class="fw-normal   accordion-button py-2 rounded-0 border-0 outline-0 " type="button"
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="variant_sku__{{ $variant->name }}"
                                                                                    placeholder="Sku"
