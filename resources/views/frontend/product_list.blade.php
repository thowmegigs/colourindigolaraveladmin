...
<style>
    ...
    <section class="py-5 products-listing bg-light">
        <div class="container bg-white" style="padding-top: 15px;padding-bottom: 10px;height:170px;">
            <div class="row">
                <div class="col-md-12">
                     <div class="swiper swiper_cat" style="height:150px">
                        ...
                        @endif
                                            ...
                                            <div class="category-content text-center">
                                                <h6 class="category-name text-center">
                                                    <a href="/products/{{ $g->name }}" style="font-size:12px">{{ $g->name }}</a>
                                                </h6>
                                            </div>
                                        </div>
    ...
    <div class="container my-sm-4" x-data="{
                    html: '',
                    loading: false,
                    controller: null,
                    category: [],
                    ...
                    fetchContent(reset=false) {
                        ...
                        fetch('/product_list?page='+this.page, {
        ...
        <div class="row">
                ...
                <div class="filters mobile-filters shadow-sm rounded bg-white mb-4 d-none d-block d-md-none">
                    <div class="border-bottom">
                        <a class="h6 font-weight-bold text-dark d-block m-0 p-3" data-toggle="collapse"
                            ...
                            aria-controls="mobile-filters"><i class="fa fa-filter"></i> Filter By <i
                    ...
                    <div id="mobile-filters" class="filters-body collapse multi-collapse">
                        <div id="accordion">
                            ...
                            @if(count($child_categories->toArray()) > 0)
                                <div class="filters-card border-bottom p-3">
            ...
            <div class="col-md-9 pt-2">
                ...
                <div id="end" style="height:100px;" class="bg-light"></div>
            </div>
        </div>
    </div>
    </div>
