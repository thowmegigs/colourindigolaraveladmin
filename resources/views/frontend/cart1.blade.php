                    ...
                    <div class="row gutter-lg mb-10">
                        <div class="col-lg-8 pr-lg-4 mb-6">
                            <div x-data>
                                ...
                                <template x-if="$store.cart.applied_offers!=undefined">
                                    ...
                                    <div class="d-flex justify-content-start alert alert-success" style="height:55px">
                                        ...
                                        {{-- <x-frontend.applied_offers ::offers="$store.cart.applied_offers" />&nbsp;&nbsp;&nbsp; --}}
                                                ...
                                                <td class="product-name">
                                                    ...
                                                    <template x-if="item.is_combo_offer=='Yes'">
                                                        <div class="col-md-12 ms-5 p-2 d-flex"
                                                           ...
                                                           <p>Product Added As combo Offer</p></div>
                                                    </template>
                                                    <template x-if="item.product_discount_offer_text!=null">
                                                        <div class="col-md-12 ms-5 p-2 d-flex bg-success"
                                                           ...
                                                           <p
                                                                x-text="item.product_discount_offer_text"></p>
                                                        </div>
                                                    </template>
                                                </td>
