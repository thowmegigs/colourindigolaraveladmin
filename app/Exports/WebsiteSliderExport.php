...
class WebsiteSliderExport  implements FromQuery,WithColumnFormatting, WithMapping,WithHeadings
{
    use Exportable;
    /**
   ...
   public function query()
    ...
    public function map($row): array
    {
        ...
        foreach ($this->export_columns as $colname) {
            $val = null;
            if (isFieldPresentInTableAsColumn('App\Models\WebsiteSlider', $colname)) {
                $val = $row->{$colname};
